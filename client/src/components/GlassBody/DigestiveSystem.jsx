...
export default function DigestiveSystem({ riskScore = 0.15, onClick, hovered, ...props }) {
  const ref = useRef();
  const model = useNormalizedGLTF("/models/digestive_system__human_anatomy.glb", 0.35);
